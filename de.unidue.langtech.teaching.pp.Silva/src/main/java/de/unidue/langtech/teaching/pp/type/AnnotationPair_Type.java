...
public class AnnotationPair_Type extends Annotation_Type {
  ...
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.unidue.langtech.teaching.pp.type.AnnotationPair.java");
  ...
  public int getAnnotation1(int addr) {
      ...
      jcas.throwFeatMissing("Annotation1", "de.unidue.langtech.teaching.pp.type.AnnotationPair.java");
  ...
  public int getAnnotation2(int addr) {
      ...
      jcas.throwFeatMissing("Annotation2", "de.unidue.langtech.teaching.pp.type.AnnotationPair.java");
  ...
  public String getStringRepresentation1(int addr) {
      ...
      jcas.throwFeatMissing("StringRepresentation1", "de.unidue.langtech.teaching.pp.type.AnnotationPair.java");
  ...
  public String getStringRepresentation2(int addr) {
      ...
      jcas.throwFeatMissing("StringRepresentation2", "de.unidue.langtech.teaching.pp.type.AnnotationPair.java");
