...
public class WeightedAnnotationPair_Type extends AnnotationPair_Type {
  ...
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.unidue.langtech.teaching.pp.type.WeightedAnnotationPair");
  ...
  public double getWeight(int addr) {
      ...
      jcas.throwFeatMissing("weight", "de.unidue.langtech.teaching.pp.type.WeightedAnnotationPair");
