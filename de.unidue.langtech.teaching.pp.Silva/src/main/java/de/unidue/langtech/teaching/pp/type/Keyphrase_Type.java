...
public class Keyphrase_Type extends Annotation_Type {
  ...
  public double getScore(int addr) {
      ...
      jcas.throwFeatMissing("score", "de.unidue.langtech.teaching.pp.type.Keyphrase");
  ...
  public String getKeyphrase(int addr) {
      ...
      jcas.throwFeatMissing("keyphrase", "de.unidue.langtech.teaching.pp.type.Keyphrase");
